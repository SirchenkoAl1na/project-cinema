...
if (!isset($groups) || empty($groups)) {
    ...
    <?php
            ...
            <div class="film-card">
                ...
                <button class="button-detail" onclick="location.href='/film?id=<?php echo $film->id; ?>'" title="Переглянути інформацію про фільм">
    ...
    <?php
        ...
        foreach ($groups as $group) {
            ...
            foreach ($group['seanses'] as $seanse) {
                ...
                <i class="fa-solid fa-ticket icon" title="Продати квиток(-ки)" onclick="location.href='/seanse?seanse_id=<?= $seanse->id ?>'"></i>
                </div>
                <?php
            }
            ?>
