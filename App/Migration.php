...
class Migration
{
    ...
    private static $insert_data = [
        ...
        [
            ...
            ('Оппенгеймер','tt15398776', 'Oppenheimer', '2026-03-01', 180, '2026-04-30', '{\"genres\": [\"Драма\", \"Біографія\"], \"director\": \"Крістофер Нолан\", \"cast\": [\"Кілліан Мерфі\", \"Роберт Дауні-молодший\"]}', 'film1.png'),
            ('Тенет','tt6723592', 'Tenet', '2026-03-01', 150, '2026-04-30', '{\"genres\": [\"Фантастика\", \"Бойовик\"], \"director\": \"Крістофер Нолан\", \"cast\": [\"Роберт Паттінсон\", \"Джон Девід Вашингтон\"]}', 'film2.png'),
            ('Дюна','tt1160419', 'Dune', '2026-03-01', 155, '2026-04-30', '{\"genres\": [\"Фантастика\", \"Драма\"], \"director\": \"Дені Вільньов\", \"cast\": [\"Тімоті Шаламе\", \"Зендея\"]}', 'film3.png'),
            ('Аватар: Шлях води','tt1630029', 'Avatar: The Way of Water', '2026-03-01', 192, '2026-04-30', '{\"genres\": [\"Фантастика\", \"Пригоди\"], \"director\": \"Джеймс Кемерон\", \"cast\": [\"Сем Вортінгтон\", \"Зої Салдана\"]}', 'film4.png'),
            ('Місія нездійсненна 7','tt9603208', 'Mission: Impossible - Dead Reckoning Part One', '2026-03-01', 163, '2026-04-30', '{\"genres\": [\"Бойовик\", \"Трилер\"], \"director\": \"Крістофер МакКворі\", \"cast\": [\"Том Круз\", \"Гейлі Етвелл\"]}', 'film5.png'),
            
            ('Вбивці квіткового місяця','tt5537002', 'Killers of the Flower Moon', '2026-05-01', 206, '2026-06-30', '{\"genres\": [\"Драма\", \"Кримінал\"], \"director\": \"Мартін Скорсезе\", \"cast\": [\"Леонардо Ді Капріо\", \"Роберт Де Ніро\"]}', 'film6.png'),
            ('Барбі','tt1517268', 'Barbie', '2026-05-01', 114, '2026-06-30', '{\"genres\": [\"Комедія\", \"Фентезі\"], \"director\": \"Грета Гервіг\", \"cast\": [\"Марго Роббі\", \"Раян Гослінг\"]}', 'film7.png'),
            ('Матриця: Воскресіння','tt10838180', 'The Matrix Resurrections', '2026-05-01', 148, '2026-06-30', '{\"genres\": [\"Наукова фантастика\", \"Бойовик\"], \"director\": \"Лана Вачовскі\", \"cast\": [\"Кіану Рівз\", \"Керрі-Енн Мосс\"]}', 'film8.png'),
            ('Початок','tt1375666', 'Inception', '2026-05-01', 148, '2026-06-30', '{\"genres\": [\"Наукова фантастика\", \"Трилер\"], \"director\": \"Крістофер Нолан\", \"cast\": [\"Леонардо Ді Капріо\", \"Джозеф Гордон-Левітт\"]}', 'film9.png'),
            ('Інтерстеллар','tt0816692', 'Interstellar', '2026-05-01', 169, '2026-06-30', '{\"genres\": [\"Наукова фантастика\", \"Пригоди\"], \"director\": \"Крістофер Нолан\", \"cast\": [\"Меттью Мак-Конахі\", \"Енн Гетевей\"]}', 'film10.png'),
            ('Форсаж 10','tt5433140', 'Fast X', '2026-05-01', 141, '2026-06-30', '{\"genres\": [\"Бойовик\", \"Пригоди\"], \"director\": \"Луїс Летер’є\", \"cast\": [\"Він Дізель\", \"Мішель Родрігес\"]}', 'film11.png'),
            ('Джон Уік 4','tt10366206', 'John Wick: Chapter 4', '2026-05-01', 169, '2026-06-30', '{\"genres\": [\"Бойовик\", \"Трилер\"], \"director\": \"Чад Стахельські\", \"cast\": [\"Кіану Рівз\", \"Донні Єн\"]}', 'film12.png'),
            
            ('Вартові галактики 3','tt6791350', 'Guardians of the Galaxy Vol. 3', '2026-07-01', 150, '2026-08-30', '{\"genres\": [\"Наукова фантастика\", \"Бойовик\", \"Комедія\"], \"director\": \"Джеймс Ґанн\", \"cast\": [\"Кріс Пратт\", \"Зої Салдана\"]}', 'film13.png'),
            ('Людина-павук: Навколо Всесвіту','tt9362722','Spider-Man: Across the Spider-Verse', '2026-07-01', 140, '2026-08-30', '{\"genres\": [\"Анімація\", \"Пригоди\", \"Бойовик\"], \"director\": \"Хоакім Дос Сантос\", \"cast\": [\"Шамеїк Мур\", \"Гейлі Стайнфелд\"]}', 'film14.png'),
            ('Трансформери: Час звірів', 'tt5090568','Transformers: Rise of the Beasts', '2026-07-01', 127, '2026-08-30', '{\"genres\": [\"Наукова фантастика\", \"Бойовик\"], \"director\": \"Стівен Кейпл-молодший\", \"cast\": [\"Ентоні Рамос\", \"Домінік Фішбек\"]}', 'film15.png'),
            ('Флеш',  'tt0439572','The Flash','2026-07-01', 144, '2026-08-30', '{\"genres\": [\"Фантастика\", \"Пригоди\", \"Бойовик\"], \"director\": \"Андрес Мускетті\", \"cast\": [\"Езра Міллер\", \"Бен Аффлек\"]}', 'film16.png'),
            ('Русалонька', 'tt5971474','The Little Mermaid', '2026-07-01', 135, '2026-08-30', '{\"genres\": [\"Мюзикл\", \"Фентезі\", \"Сімейний\"], \"director\": \"Роб Маршалл\", \"cast\": [\"Холі Бейлі\", \"Джона Гавер-Кінг\"]}', 'film17.png'),
            ('Індіана Джонс і реліквія долі','tt1462764', 'Indiana Jones and the Dial of Destiny', '2026-07-01', 154, '2026-08-30', '{\"genres\": [\"Пригоди\", \"Бойовик\"], \"director\": \"Джеймс Менголд\", \"cast\": [\"Гаррісон Форд\", \"Фібі Воллер-Брідж\"]}', 'film18.png'),
            ('Елементарно','tt15789038', 'Elemental', '2026-07-01', 102, '2026-08-30', '{\"genres\": [\"Анімація\", \"Комедія\", \"Сімейний\"], \"director\": \"Пітер Сон\", \"cast\": [\"Леа Льюїс\", \"Мамуду Аті\"]}', 'film19.png'),
            ('Місто астероїдів','tt14230388', 'Asteroid City', '2026-07-01', 105, '2026-08-30', '{\"genres\": [\"Комедія\", \"Драма\", \"Фантастика\"], \"director\": \"Вес Андерсон\", \"cast\": [\"Джейсон Шварцман\", \"Скарлетт Йоганссон\"]}', 'film20.png')"
        ],
        [
            'table' => 'employee',
